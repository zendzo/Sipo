...
<h1>Summary<small>Create</small></h1>
<ol class="breadcrumb">
...
<div class="box box-primary">
    ...
    <!-- form start -->
    {{ Form::open(['route'=>'summaries.store','role'=>'form']) }}
        <div class="box-body">
            <div class="form-group">
                {{ Form::label('name','Name :') }}
                {{ Form::text('name',null,['placeholder'=>'Summary Name','class'=>'form-control','required'=>'required']) }}
            </div>
            <div class="form-group">
