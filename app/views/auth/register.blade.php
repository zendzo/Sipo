...
<html class="bg-black">
    <head>
        <meta charset="UTF-8">
        <title>Gurindam | Registration Page</title>
        ...
        <div class="form-box" id="login-box">
            ...
            {{ Form::open(['route'=>'registration.store']) }}
                <div class="body bg-gray">
                    ...
                    <div class="form-group">
                        {{ Form::text('occupation',null,['class'=>'form-control','placeholder'=>'occupation','required'=>'required']) }}
                    ...
                    <div class="form-group">
                        {{ Form::password('password_confirmation',['class'=>'form-control','placeholder'=>'Password Confirmation','required'=>'required']) }}
                    </div>
                </div>
                <div class="footer">                    
                    ...
                    {{ link_to('login','I already have a membership') }}
                </div>
            {{ Form::close() }}
        </div>
